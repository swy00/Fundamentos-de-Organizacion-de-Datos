...
begin
	...
	begin
		...
		while (datoM.sucursal = sucursal_actual) do
        begin
			...
			while (datoM.sucursal = sucursal_actual) and (datoM.empleado = empleado_actual) do 
			begin
				...
				while (datoM.sucursal = sucursal_actual) and (datoM.empleado = empleado_actual) and (datoM.fecha = fecha_actual)  do
				begin
