...
{
imprimirMaestro: Imprime los registros activos en el archivo maestro.
imprimirMaestroDebug: Imprime todos los registros en el archivo maestro, incluidos los eliminados.
crearMaestro: Crea y inicializa el archivo maestro con un registro de cabecera.
agregar: Agrega un nuevo registro al archivo maestro, utilizando la lista invertida si hay espacio disponible (es decir, si hay registros eliminados que pueden ser reutilizados).
eliminar: Marca un registro como eliminado y actualiza la cabecera para que apunte al registro eliminado.
* }
program apuntes;
type 
    tregistro = record 
